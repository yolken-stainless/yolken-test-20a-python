...
from ._exceptions import APIStatusError, YolkenTest20aError
...
class YolkenTest20a(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest20a client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST_20A_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest20aWithRawResponse:
        return YolkenTest20aWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest20aWithStreamedResponse:
        return YolkenTest20aWithStreamedResponse(self)
...
class AsyncYolkenTest20a(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest20a client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest20aWithRawResponse:
        return AsyncYolkenTest20aWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest20aWithStreamedResponse:
        return AsyncYolkenTest20aWithStreamedResponse(self)
...
class YolkenTest20aWithRawResponse:
    _client: YolkenTest20a

    def __init__(self, client: YolkenTest20a) -> None:
        self._client = client
...
class AsyncYolkenTest20aWithRawResponse:
    _client: AsyncYolkenTest20a

    def __init__(self, client: AsyncYolkenTest20a) -> None:
        self._client = client
...
class YolkenTest20aWithStreamedResponse:
    _client: YolkenTest20a
...
class AsyncYolkenTest20aWithStreamedResponse:
    _client: AsyncYolkenTest20a
...
AsyncClient = AsyncYolkenTest20a
